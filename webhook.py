...
projectSearchString = 'project=XY order by key desc' #TODO build your own query string for jql(https://confluence.atlassian.com/jiracore/blog/2015/07/search-jira-like-a-boss-with-jql)
